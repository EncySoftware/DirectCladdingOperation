...
using System.Xml;
using DirectCladdingOperationExtension;
...
{
    private const string NodeOperationXMlName = "DirectCladdingOperation_ExtOp.xml";
    ...
    public IExtension? Create(string extensionIdent, out TResultStatus ret)
    {
        ...
        {
            ret = default;
            if (extensionIdent == "DirectCladdingOperationExtension.ToolPathCalculation")
    ...
    public void OnLibraryRegistered(IExtensionFactoryContext context, out TResultStatus ret)
    {
        ...
        try
        {
            ...
            Directory.CreateDirectory(context.Paths.OperationsFolder);
